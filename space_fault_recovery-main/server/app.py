...
"""
FastAPI application for the Space Fault Recovery Environment.

This module creates an HTTP server that exposes the SpaceFaultRecoveryEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m space_fault_recovery.server.app
    ...
    multiple workers:
        uvicorn space_fault_recovery.server.app:app --workers 4
    """
    import uvicorn
